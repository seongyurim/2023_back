...
public class Decryptor implements Decryptable{
    ...
    DecryptLowercaseByTable mtable;
    DecryptUppercaseByTable mtable2;
    
    public Decryptor() {
        mtable = new DecryptLowercaseByTable();
        mtable2 = new DecryptUppercaseByTable();
    }
    ...
    public String decrypt(String encData) {
        ...
        for (int i = 0; i < encData.length(); i++) {
            ...
            // 매핑테이블에서 찾는다.
            decData += mtable2.decoding(encChar);
        }
        return decData;
    }
